...
namespace Anet.Echo.Notifications.WebHook
{
    ...
    public class WebHook
    {
        ...
        public string Id
        {
            ...
            set
            {
                id = string.IsNullOrEmpty(value) ? getNewId() : value;
            }
        }
        ...
        /// </summary>
        [Required, StringLength(maximumLength: 64, MinimumLength = 32, ErrorMessageResourceType = typeof(byte[]), ErrorMessageResourceName = "WebHook_InvalidSecret")]
